...
class HomeController extends Controller
{
    public function home(){
        ...
        $posts = Post::with(['comments.user', 'tags', 'likes', 'user'])->limit(3)->get();
        return view('home', [
            'posts'=> $posts,
    ...
    public function blog(){
        ...
        $posts = Post::with(['comments.user', 'tags', 'likes', 'user'])->orderBy('created_at', 'desc')->paginate(6);
    ...
    public function education(){
        $pagetitle = 'Education ';
        return view('domaine_activite.education', [
            'pagetitle' => $pagetitle,
        ]);
    }
    public function btp(){
        $pagetitle = 'BTP ';
        return view('domaine_activite.btp', [
            'pagetitle' => $pagetitle,
        ]);
    }
    public function immobilier(){
        $pagetitle = 'Immobilier ';
        return view('domaine_activite.immobilier', [
            'pagetitle' => $pagetitle,
        ]);
    }
    public function fintech(){
        $pagetitle = 'Fintech ';
        return view('domaine_activite.fintech', [
            'pagetitle' => $pagetitle,
        ]);
    }

    public function softareAppDevelopment(){
        $pagetitle = 'Software & App development ';
        return view('expertise.software_app_development', [
            'pagetitle' => $pagetitle,
        ]);
    }
    public function dataManagement(){
        $pagetitle = 'Data Enrichment and Management';
        return view('expertise.data_enrichment_management', [
            'pagetitle' => $pagetitle,
        ]);
    }
    public function cyberSecurity(){
        $pagetitle = 'Cyber Security';
        return view('expertise.cyber_security', [
            'pagetitle' => $pagetitle,
        ]);
    }

    public function nosOffresEmplois(){
        $pagetitle = 'Nos offres d\'emplois ';
        return view('nos_offres_emplois', [
            'pagetitle' => $pagetitle,
        ]);
    }

    public function devenirActionnaire(){
        $pagetitle = 'Dévenir actionnaire ';
        return view('devenir_actionnaire', [
            'pagetitle' => $pagetitle,
        ]);
    }
